-- ISO 8859-1 values use numeric notation independent of source encoding.
package Ada.Characters.Latin_1 is
    ...
    Low_Line : constant Character := Character'Val (95);
    Grave : constant Character := Character'Val (96);
    LC_A : constant Character := Character'Val (97);
    LC_B : constant Character := Character'Val (98);
    LC_C : constant Character := Character'Val (99);
    LC_D : constant Character := Character'Val (100);
    LC_E : constant Character := Character'Val (101);
    LC_F : constant Character := Character'Val (102);
    LC_G : constant Character := Character'Val (103);
    LC_H : constant Character := Character'Val (104);
    LC_I : constant Character := Character'Val (105);
    LC_J : constant Character := Character'Val (106);
    LC_K : constant Character := Character'Val (107);
    LC_L : constant Character := Character'Val (108);
    LC_M : constant Character := Character'Val (109);
    LC_N : constant Character := Character'Val (110);
    LC_O : constant Character := Character'Val (111);
    LC_P : constant Character := Character'Val (112);
    LC_Q : constant Character := Character'Val (113);
    LC_R : constant Character := Character'Val (114);
    LC_S : constant Character := Character'Val (115);
    LC_T : constant Character := Character'Val (116);
    LC_U : constant Character := Character'Val (117);
    LC_V : constant Character := Character'Val (118);
    LC_W : constant Character := Character'Val (119);
    LC_X : constant Character := Character'Val (120);
    LC_Y : constant Character := Character'Val (121);
    LC_Z : constant Character := Character'Val (122);
    ...
    -- Constant equivalents of the standard object renamings.
    Minus_Sign : constant Character := Hyphen;
    IS4 : constant Character := FS;
    IS3 : constant Character := GS;
    IS2 : constant Character := RS;
    IS1 : constant Character := US;
    NBSP : constant Character := No_Break_Space;
    Ring_Above : constant Character := Degree_Sign;
    Paragraph_Sign : constant Character := Pilcrow_Sign;
